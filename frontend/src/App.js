...
import MercariLogo from "./logo.png";
...
function App() {
  ...
  return (
    <div ref={messagesContainerRef} className="App">
      <div className="WelcomeTextBackground" >
        <img className="image" src={MercariLogo} alt="mercari logo"/>
        <h2 className="WelcomeText">ChatBot</h2>
      </div>
      ...
      <div className="QueryHolder">
        <button className="NewButton" onClick={clearChat}>
          <i class="fa-solid fa-trash BroomImage"></i>
          </button>
        <form>
        ...
        <button className="NewButton SendButton" onClick={handleSubmit}>
          <i class="fa-solid fa-paper-plane ChatImage" aria-hidden="false"></i>
        </button>
      </div>
    </div>
  );
